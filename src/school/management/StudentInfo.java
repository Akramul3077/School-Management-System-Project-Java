...
public class StudentInfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("ID   :");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 94, 65, -1));

        Id.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jPanel1.add(Id, new org.netbeans.lib.awtextra.AbsoluteConstraints(63, 89, 260, 33));
        ...
        jPanel1.add(Add, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 140, 124, 37));
        ...
        jPanel1.add(Clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 140, 121, 37));
        ...
        Student_Info.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Roll", "Name", "Father Name", "Mother Name", "Phone", "Address", "Religion", "Class", "Section", "Session", "Gender", "Date of Birth", "Blood Group"
            }
        ));
        jScrollPane1.setViewportView(Student_Info);
        if (Student_Info.getColumnModel().getColumnCount() > 0) {
            Student_Info.getColumnModel().getColumn(0).setPreferredWidth(400);
            Student_Info.getColumnModel().getColumn(1).setPreferredWidth(200);
            Student_Info.getColumnModel().getColumn(2).setPreferredWidth(500);
            Student_Info.getColumnModel().getColumn(3).setPreferredWidth(700);
            Student_Info.getColumnModel().getColumn(4).setPreferredWidth(700);
            Student_Info.getColumnModel().getColumn(5).setPreferredWidth(500);
            Student_Info.getColumnModel().getColumn(6).setPreferredWidth(500);
            Student_Info.getColumnModel().getColumn(7).setPreferredWidth(500);
            Student_Info.getColumnModel().getColumn(8).setPreferredWidth(300);
            Student_Info.getColumnModel().getColumn(9).setPreferredWidth(300);
            Student_Info.getColumnModel().getColumn(10).setPreferredWidth(300);
            Student_Info.getColumnModel().getColumn(11).setPreferredWidth(300);
            Student_Info.getColumnModel().getColumn(12).setPreferredWidth(500);
            Student_Info.getColumnModel().getColumn(13).setPreferredWidth(700);
        }
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 90, 600, 440));
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 80, 50));

        jLabel1.setFont(new java.awt.Font("Stencil Std", 1, 48)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Students Information");
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 933, 70));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Background Image/ak.png"))); // NOI18N
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 930, 80));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -20, 930, 100));
